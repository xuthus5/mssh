...
- High-rate output additionally uses lossless PTY backpressure; xterm parsing backlog pauses the matching backend reader at 256 KiB and resumes at 64 KiB.
...
## Output coalescing and lossless flow control
...
| Terminal output | high-rate inactive/active tab | Coalescer + flow control (256/64 KiB) | bounded, ordered, lossless writes; backend reader pauses at high water |
