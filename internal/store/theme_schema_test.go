...
var expectedFinalSchemaSQL = map[string]string{
	...
	"sessions": `CREATE TABLE sessions (
		...
		jump_auth_method TEXT NOT NULL DEFAULT 'password' CHECK(jump_auth_method IN ('password','key','agent','keyboard-interactive')),
		jump_password TEXT NOT NULL DEFAULT '',
		jump_key_id INTEGER REFERENCES ssh_keys(id),
