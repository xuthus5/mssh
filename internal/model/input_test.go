...
func TestTerminalGlobalStyleInputConversions(t *testing.T) {
	input := TerminalGlobalStyleInput{FontFamily: "JetBrains Mono", FontSize: 16, CursorStyle: CursorStyleBlock, CursorColor: "#abcdef", SelectionBackground: "#123456", LigaturesEnabled: true}
