...
- Local AI operations panel with models.dev provider/model presets, multi-provider fallback, terminal context, web search, command risk classification, approval, and per-session history
