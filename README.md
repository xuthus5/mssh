...
- SFTP file transfer with native dialogs, hidden-file filtering, terminal-directory following, list/tree views, and a global progress, retry, history, ETA, and cancellation center
