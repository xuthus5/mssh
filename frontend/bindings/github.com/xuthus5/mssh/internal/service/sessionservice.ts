 ...
 */
export function GetSessionCredentials(id: number): $CancellablePromise<model$0.SessionCredentials | null> {
    return $Call.ByName("github.com/xuthus5/mssh/internal/service.SessionService.GetSessionCredentials", id).then(($result: any) => {
...
const $$createType5 = model$0.SessionCredentials.createFrom;
