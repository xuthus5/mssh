...
describe('application entry', () => {
  ...
  it('mounts the application once without strict mode remounting', async () => {
    ...
    expect(element.props.children).toEqual(expect.any(Function))
    const application = element.props.children()
    expect(application.type.name).toBe('TooltipProvider')
    expect(application.props.children.type.name).toBe('AppErrorBoundary')
    expect(application.props.children.props.children.type.name).toBe('default')
