...
export function profileToTerminalTheme(profile: ThemeProfile): TerminalTheme {
  ...
  return {
    ...
    selectionBackground: merged.selection,
    cursorStyle: profile.cursor_style as TerminalTheme['cursorStyle'],
