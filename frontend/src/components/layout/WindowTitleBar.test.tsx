...
vi.mock('@/lib/wails', () => ({
  ...
  ThemeService: {
    ...
    GetGlobalStyle: vi.fn(async () => ({ font_family: 'monospace', font_size: 14, cursor_style: 'bar', cursor_color: '#0969da', selection_background: '#264f78', ligatures_enabled: false })),
  },
}))
