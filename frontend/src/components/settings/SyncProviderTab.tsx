...
import { Cloud, Database, GitFork, PlugZap } from 'lucide-react'
...
export function SyncProviderTab(props: Props) {
  ...
  return <div className="flex flex-col gap-5">
    ...
    <div className="border-t border-border pt-5">
      {props.input.provider === SyncProvider.SyncProviderGist && <GistFields {...props} />}
      {props.input.provider === SyncProvider.SyncProviderWebDAV && <WebDAVFields {...props} />}
      {props.input.provider === SyncProvider.SyncProviderS3 && <S3Fields {...props} />}
    </div>
