...
const systemInfo = { cpu_percent: 42, cpu_count: 8, memory_used: 2 * 1024 ** 3, memory_total: 8 * 1024 ** 3, disk_used: 10 * 1024 ** 3, disk_total: 100 * 1024 ** 3, download_rate: 1024, upload_rate: 2048, swap_used: 0, swap_total: 0, load_1: 1.2, load_5: 0.8, load_15: 0.4, uptime_seconds: 3661, os_name: 'Ubuntu', kernel_version: '6.8' }
...
describe('SystemPanel', () => {
  ...
  it('renders overview metrics and refreshes from the terminal service', async () => {
    ...
    expect(screen.getByText(/系统 Ubuntu/)).toBeInTheDocument()
