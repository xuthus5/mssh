...
function PanelHeader({ onClose }: { onClose: () => void }) {
  return <div className="flex items-center justify-between border-b border-border px-3 py-2"><span className="text-sm font-medium">文件管理</span><Button size="xs" variant="ghost" onClick={onClose}>关闭</Button></div>
}
